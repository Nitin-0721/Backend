...
const loginUser = asyncHandler(async(req,res)=>{
    ...
    const user = await User.findOne({
      $or:[{username},{email}]  //using of dollar sign for checkinf both email or username
    })
    ...
    select("-password -refreshToken")      //select is used to -> jo hume nahi chahiye
...
const logoutUser = asyncHandler(async(req,res)=>{
  //cookies, token sare clear krne honge
...
const updateUserAvatar = asyncHandler(async(req,res)=>
  {
    ...
    //todo: delete the previous image after uploading new one
...
const getUserChannelProfile = asyncHandler(async(req,res)=>{
 ...
 .status(200)
 .json(
  new ApiResponse(200,channel[0],"User channel fetched successfullyk")
 )
